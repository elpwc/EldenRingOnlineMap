  ...
  map: {
    ...
    modals: {
      ...
      register: {
        ...
        wait_for_one_minute: '請等待 {seconds} 秒',
        email_blank: '還沒有輸入郵箱哦',
        username_blank: '記得輸入用戶名哦',
        password_blank: '密碼還沒有輸入哦',
        username_wrong: '用戶id請使用字母和數字，長度在2-20之間',
        password_wrong: '密碼請使用字母和數字，長度在2-20之間',
        verification_code_blank: '郵箱驗證碼還沒有輸入哦',
        verification_code_error: '郵箱驗證碼不正確哦',
        verification_code_send: '已發送, 如果沒有收到請檢查垃圾郵件',
        verification_code_send_fail: '郵件發送失敗，請檢查郵箱是否有問題',
      },
      login: {
        title: '登入',
        email: '郵箱',
