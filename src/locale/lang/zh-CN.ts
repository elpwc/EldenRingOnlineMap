const lang = {
  ...
  map: {
    ...
    left: {
      ...
      cave: '在洞穴的',
      afterBurning: '灰城的',
      tips: '点击地标可以查看详细|右键or长按地标可以快速隐藏/收藏|可以在"编辑"里移动地标|在设置里可以繁简切换|遇到bug请反馈到讯息里捏|"隐藏恶评"可以不显示恶评多的地标',
      showNameButton: '显示地名',
      fontSizeLabel: '字号',
      fontSizeSmall: '小',
      fontSizeMedium: '中',
    ...
    modals: {
      ...
      register: {
        title: '创建账号',
        username: '用户id  (由数字和字母组成)',
        password: '密码',
        password2: '重复密码',
        exist: '这个用户id已经存在，请换一个吧',
        not_recaptcha: '请点击下面进行人机身份验证',
