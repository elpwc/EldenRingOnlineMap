  ...
  <div id="modalContainer">
    ...
    <div class="update">
      ...
      <div class="updateSection">
        <p>有任何问题请进入反馈群→ 161952806</p>
      </div>
      <div class="updateSection">
        <p class="sectionTitle">💡 新的<ruby>特性</ruby>:</p>
        <p>
          - 在底部菜单添加了<a href="https://www.wanjiadongli.com/games/2815?tab=2&inviteCode=eldenringmap114514" target="_blank"
            >Mod/修改器
            <sup>
              <SubscriptLink10 />
            </sup>
    ...
    <hr />
    <div class="update">
      <p class="updateTitle"><date>2026-1-19 17:31 UT+8</date> 的更新<br />(ver 3.3.1.4)</p>
      <div class="updateSection">
        <p>时隔一年的更新 感谢大家数年来的使用和支持喵!</p>
        <p>有任何问题请大胆进入反馈群→ 161952806</p>
      </div>
      <div class="updateSection">
        <p class="sectionTitle">🐞 修复了bug:</p>
        <p>- 加入了DLC地图後，搜索结果中不再包含地下和DLC坐标的bug（一直没注意到这个问题对不起..🥺）</p>
      </div>
      <div class="updateSection">
        <p class="sectionTitle">💡 新的<ruby>特性</ruby>:</p>
        <p>
          - 与玩家动力达成了合作，添加了<a href="https://www.wanjiadongli.com/games/2815?tab=2&inviteCode=eldenringmap114514" target="_blank"
            >Mod/修改器
            <sup>
              <SubscriptLink10 />
            </sup>
    ...
    <hr />
    <div class="update">
      <p class="updateTitle"><date>2024-6-23 4:50 UT+8</date> 的更新<br />(ver 3.3.1.3)</p>
