...
export const getSiteTypeFilters = $t => [
  ...
  { name: $t('siteTypes.filters.jiejing'), value: MapPointType.Jiejing, icon: MapIcon.yellow(true) },
  ...
  { name: $t('siteTypes.filters.lianji'), value: MapPointType.Lianji, icon: MapIcon.yellow(true) },
  { name: $t('siteTypes.filters.wind'), value: MapPointType.Wind, icon: MapIcon.yellow(), emoji: '🌀' },
  { name: $t('siteTypes.filters.cave'), value: MapPointType.Cave, icon: MapIcon.yellow(true) },
  ...
  { name: $t('siteTypes.filters.bigboss'), value: MapPointType.BigBoss, icon: MapIcon.boss(true) },
  ...
  { name: $t('siteTypes.filters.shengbeiludi'), value: MapPointType.ShengbeiLudi, icon: MapIcon.blue(), emoji: '🍷' },
  ...
  { name: $t('siteTypes.filters.metarial'), value: MapPointType.Material, icon: MapIcon.blue(true) },
  { name: $t('siteTypes.filters.importantitem'), value: MapPointType.ImportantItem, icon: MapIcon.blue(true) },
  ...
  { name: $t('siteTypes.filters.taoke'), value: MapPointType.Taoke, icon: MapIcon.message(true) },
];
